...
where m.away_team = ts1.team_id and m.season = ts1.season_id and ts1.matchday = m.matchday - 1 
	and m.home_team = ts2.team_id and m.season = ts2.season_id and ts2.matchday = m.matchday - 1 